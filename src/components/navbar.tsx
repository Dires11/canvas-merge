      ...
      <GlassContainer className="flex items-center justify-between gap-2 px-3 py-2 sm:gap-3 sm:px-4">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-5">
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="glass-border dark:bg-background/70 min-w-28 rounded-xl bg-white/60 p-1.5 shadow-lg backdrop-blur-xl"
            >
          ...
          <div
            ...
            className="glass-border dark:bg-glass/5 hidden w-[5.75rem] grid-cols-3 rounded-full bg-white/35 p-1 shadow-[0_1px_4px_rgb(15_23_42_/_0.08)] backdrop-blur-lg sm:grid dark:shadow-none"
          >
